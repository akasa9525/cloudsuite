...
${MAHOUT_HOME}/bin/mahout split -i /user/root/wiki-vectors/tfidf-vectors --trainingOutput /user/root/training --testOutput /user/root/testing -rp 20 -ow -seq -xm sequential
# Train Bayes model
